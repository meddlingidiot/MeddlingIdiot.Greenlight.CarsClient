...
/// <summary>
/// Whether the cars come back when Windows does. One value under the current user's
...
/// <c>cars.json</c>: the user can turn the same thing off in Task Manager's Startup tab or
...
public static class WindowsStartup
{
    ...
    /// </summary>
    private const string ValueName = "Greenlight Cars";

    /// <summary>Whether Windows is currently set to start the cars.</summary>
    ...
    /// <summary>Ask Windows to start the cars, or stop asking. Returns what it actually is afterwards.</summary>
    ...
    /// </summary>
    /// <remarks>
    /// A Velopack install looks like <c>…\Greenlight.CarsClient\current\Greenlight.CarsClient.exe</c>,
